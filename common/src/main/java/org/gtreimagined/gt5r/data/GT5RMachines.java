...
public class GT5RMachines {
    ...
    public static MultiMachine LARGE_SIFTER = new MultiMachine(GT5RRef.ID, "large_sifter").setTiers(EV).setMap(RecipeMaps.SIFTER).addFlags(GUI, ITEM, EU).addStructureTooltip(8).setTile(BlockEntityLargeSifter::new).setTextureBlock(GT5RBlocks.CASING_TITANIUM);
    ...
    public static MultiMachine ORE_MINING_RIG = new MultiMachine(GT5RRef.ID, "ore_mining_rig").setTiers(EV).addFlags(GUI, ITEM, FLUID, EU).addStructureTooltip(11).setTile(BlockEntityOreMiningRig::new).setTextureBlock(GT5RBlocks.CASING_SOLID_STEEL);
    ...
    public static MultiMachine PYROLYSIS_OVEN = new MultiMachine(GT5RRef.ID, "pyrolysis_oven").setTiers(MV).setMap(RecipeMaps.PYROLYSIS_OVEN).addFlags(GUI, ITEM, FLUID, EU).addStructureTooltip(12).setTile(BlockEntityPyrolysisOven::new).custom().setTextureBlock(GT5RBlocks.CASING_ULV);
