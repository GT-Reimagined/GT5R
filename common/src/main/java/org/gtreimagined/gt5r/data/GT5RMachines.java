...
public class GT5RMachines {
    ...
    public static MultiMachine ORE_MINING_RIG = new MultiMachine(GT5RRef.ID, "ore_mining_rig").setTiers(LV).addFlags(GUI, ITEM, EU).addStructureTooltip(11).setTile(BlockEntityAdvancedMiner::new).setTextureBlock(GT5RBlocks.CASING_SOLID_STEEL);
