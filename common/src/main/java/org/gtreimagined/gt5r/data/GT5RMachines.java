...
public class GT5RMachines {
    ...
    public static GeneratorMachine MAGIC_ENERGY_CONVERTER = new GeneratorMachine(GT5RRef.ID, "magic_energy_converter").setTiers(LV, MV, HV, EV).addFlags(GUI, ITEM, FLUID, CELL).allowFrontIO().efficiency(t -> {
